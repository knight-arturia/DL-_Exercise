    ...
    def next(self):
        ...
        while num_images > 0:
            ...
            if self.pointer + num_images > len(self.image_list):
                ...
                images_2_import = images_2_import + self.image_list[self.pointer:(self.pointer + num_images)]                
        ...
        for image_index in images_2_import:
            ...
            an_image = cv2.resize(an_image,(self.image_size[0],self.image_size[1]),interpolation = cv2.INTER_AREA)
            ...
            if self.rotation:
                ...
                an_image = np.rot90(an_image,k=random.randint(1,3),axes=(0,1))
            ...
            if ist_das_erst:
                ...
                images = an_image                
                labels = np.array([int(self.image_labels[image_index])],dtype=np.int8)                
                ...
                labels = np.append(labels,np.array([int(self.image_labels[image_index])],dtype=np.int8))
