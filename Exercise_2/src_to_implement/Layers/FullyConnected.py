...
class FullyConnected:
    ...
    def __init__(self, input_size, output_size):
        ...
        self.weights = None # np.random.uniform(0, 1, size=(input_size+1, output_size))
        # transmit difference
    ...
    def initialize(self, weight_initializer, bias_initializer):
        ...
        weights = weight_initializer.initialize(weight_shape, self.in_size, self.out_size)
        bias_shape = (self.in_size)
        bias = bias_initializer.initialize(bias_shape, self.in_size, 0)
        # combine weight and bias together
